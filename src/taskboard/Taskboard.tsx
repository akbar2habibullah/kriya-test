...
function Taskboard() {
  ...
  const [itemStatus, setItemStatus] = useState<TaskboardItemStatus | null>(null)
  
  const openTaskItemModalAdd = (status: string) => {
    setItemStatus(status as TaskboardItemStatus);
    setIsModalVisible(true);
  }
  
  const openTaskItemModal = (itemToEdit: TaskboardItem) => {
